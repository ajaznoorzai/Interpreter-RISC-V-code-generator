...
public class InfixLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"Quality", "LParen", "Comma", "RParen", "LBrace", "Semicolon", "RBrace", 
			"Divide", "LessEq", "MoreEq", "Times", "Plus", "Minus", "And", "Xor", 
			"LogicalOr", "Less", "More", "INTYPE", "BOOLTYPE", "UNITTYPE", "Assign", 
			"While", "Do", "Local", "IDFR", "INTLIT", "BOOLLIT", "WS", "Comment"
		};
	}
